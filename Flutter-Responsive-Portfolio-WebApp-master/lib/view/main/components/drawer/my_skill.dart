...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.90, title: 'Flutter',image: 'assets/icons/flutter.png',),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.99, title: 'Responsive Design',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.99, title: 'Clean Architecture',image: 'assets/icons/flutter.png'),
